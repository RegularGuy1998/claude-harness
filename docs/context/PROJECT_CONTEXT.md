...
- Notable versions / constraints: Rust edition 2021, workspace resolver 3. `harness-cli` version `0.1.11` pinned in lockstep with `scripts/harness-cli-release-tag` (`harness-cli-v0.1.11`). Plugin is at v0.1.0.
